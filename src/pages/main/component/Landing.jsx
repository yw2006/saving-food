...
>
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src={first_image} className="d-block w-100 h-75 image" alt="..." />
      <div className="caption d-none d-md-block text-center d-flex">
        <h5 className="text-white car-text">welcome to saving food</h5>
        <h1 className="text-white car-text2">
          Together we can <br /> Make a{" "}
          <span className="fw-bold">Deffrence.</span>
        </h1>
    ...
    <div className="carousel-item">
      <img src={sec_image} className="d-block w-100 image" alt="..." />
      <div className="caption d-none d-md-block text-center d-flex">
        <h5 className="text-white car-text">welcome to saving food</h5>
        <h1 className="text-white car-text2">
          Together we can <br /> Make a{" "}
