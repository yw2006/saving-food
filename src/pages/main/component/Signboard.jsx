...
function Signboard() {
  return (
    <div className="container board m-auto" >
      <div className="row row-cols-sm-1 row-cols-md-1 row-cols-lg-1 row-cols-xl-2 row1 w-100">
        ...
        <div className="col text">
          ...
          <ul style={{ listStyle: "none", paddingLeft: "0" }}>
            <li>
              ...
              Find out how and where you can buy farm fresh
            </li>
            <li>
              <svg
                style={{ color: "green" }}
              ...
              We use sustainable farming methods
            </li>
            <li>
              <svg
                style={{ color: "green" }}
